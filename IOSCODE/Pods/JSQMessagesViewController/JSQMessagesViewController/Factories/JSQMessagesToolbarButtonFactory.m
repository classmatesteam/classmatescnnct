...
+ (UIButton *)defaultAccessoryButtonItem
{
    ...
    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 7.0f, 32.0f)];
...
+ (UIButton *)defaultSendButtonItem
{
   /* NSString *sendTitle = [NSBundle jsq_localizedStringForKey:@"send"];
    ...
    sendButton.titleLabel.font = [UIFont fontWithName:@"Ubuntu" size:17.0f];
    ...
    */
    ...
    UIImage *redButtonImage = [UIImage imageNamed:@"send"];
    
    UIButton *sendButton = [UIButton buttonWithType:UIButtonTypeCustom];
    sendButton.frame = CGRectMake(0.0, 0.0, 37.0, 37.0);
    [sendButton setBackgroundImage:redButtonImage forState:UIControlStateNormal];
