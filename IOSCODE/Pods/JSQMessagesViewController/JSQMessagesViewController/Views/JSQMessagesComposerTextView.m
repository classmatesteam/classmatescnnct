...
- (void)jsq_configureTextView
{
    ...
    _img = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,[[UIScreen mainScreen] bounds].size.width,[[UIScreen mainScreen] bounds].size.height)];
    _img.image=[UIImage imageNamed:@"bkg"];
    //NSLog(@"Value of hello = %@", hello);
    [self.superview addSubview:_img];
    [self.superview sendSubviewToBack:_img];
    ...
    self.tintColor = [UIColor colorWithRed:0.0 green:202.0 blue:215.0 alpha:1.0];
