...
- (void)awakeFromNib
{
    ...
    self.cellTopLabel.font = [UIFont fontWithName:@"Ubuntu" size:13.0f];
    //self.cellTopLabel.textColor = [UIColor  ];
    //UIColor colorWithRed:(0x00/255) green: (0x4a/255) blue: (0x5e/255) alpha:1.0
    self.cellTopLabel.textColor = [UIColor lightGrayColor];
   
    //CGSize stringsize = [self.cellTopLabel.text sizeWithFont:[UIFont fontWithName:@"Ubuntu" size:13]];
    
    
    //self.cellTopLabel.frame=CGRectMake(self.cellTopLabel.frame.origin.x, self.cellTopLabel.frame.origin.y, stringsize.width, self.cellTopLabel.frame.size.height);
    
    self.messageBubbleTopLabel.font = [UIFont fontWithName:@"Ubuntu" size:12.0f];
    self.messageBubbleTopLabel.textColor = [UIColor lightGrayColor];
    
    self.cellBottomLabel.font = [UIFont fontWithName:@"Ubuntu" size:11.0f];
